...
FLAGS="--sysconfdir=/opt/etc --localstatedir=/opt/var --enable-tests --enable-compat-howl --enable-compat-libdns_sd"
...
case "$USER" in
    ...
    ;;
    sebest)
    FLAGS="$FLAGS --disable-monodoc --enable-dbus=no --enable-mono=no --enable-qt3=no --enable-qt4=no  --sysconfdir=/opt/etc --localstatedir=/opt/var --prefix=/usr  --disable-manpages --disable-xmltoman"
    ;;
esac
